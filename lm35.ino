...
float  BPM, SpO2,temperatureC,temperatureF;
...
const char* password = "andy1111";  //Enter Password here
...
Voltage = (RawValue / 4095.0) * 5000; // 5000 to get millivots.
tempC = Voltage * 0.1;
...
void handle_OnConnect() {
  ...
  server.send(200, "text/html", SendHTML(tempC,BPM,SpO2,temperatureC)); 
}
void handle_NotFound(){
  server.send(404, "text/plain", "Not found");
}
  String SendHTML(float tempC,float BPM,float SpO2,float temperatureC){
  String ptr = "<!DOCTYPE html>";
  ptr +="<html>";
  ptr +="<head>";
  ptr +="<title>Houssem Balti</title>";
  ...
  ptr +="</head>";
  ptr +="<body>";
  ptr +="<h1> IOT MONITORING SYSTEM</h1>";
  ptr +="<h3>Houssem Balti / CIN:14259086</h3>";
